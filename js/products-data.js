...
window.productData = {
  ...
  products: [
    ...
    },
    {
      ...
      description: "Streaming musik dan podcast tanpa iklan",
      features: ["Premium Individual", "No Ads", "Download Lagu", "Garansi"],
      stock: 75,
      sold: 950
    },
    ...
    },
    {
      ...
      category: "Editing",
      price: 60000,
      originalPrice: 170000, // Disesuaikan logis dengan harga core-nya
      ...
      features: ["No Watermark", "1 Bulan", "Private Account"],
      stock: 150,
      sold: 2200
    },
    {
...
console.log("✅ products-data.js DIPERBAIKI & DISINKRONKAN berhasil dimuat!");
