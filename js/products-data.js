...
window.productData = {
  ...
  products: [
    ...
    },
    {
      ...
      name: "Disney+ Hotstar",
      category: "Streaming",
      price: 28000, // DISESUAIKAN DENGAN products-data.js
      originalPrice: 55000,
    ...
    },
    {
      ...
      name: "iQIYI Premium",
      category: "Streaming",
      price: 19000, // DISESUAIKAN DENGAN products-data.js
      originalPrice: 25000,
    ...
    },
    {
      ...
      category: "Streaming",
      price: 23000, // DISESUAIKAN DENGAN products-data.js
      originalPrice: 30000,
    ...
    },
    {
      ...
      name: "Viu Premium",
      category: "Streaming",
      price: 8250, // DISESUAIKAN DENGAN products-data.js
      originalPrice: 10000,
      image: "../image/viu.png",
      discount: 48,
      isPopular: false,
    ...
    },
    {
      ...
      name: "HBO Go",
      category: "Streaming",
      price: 20500, // DISESUAIKAN DENGAN products-data.js
      originalPrice: 50000,
    ...
    },
    {
      ...
      name: "WeTV VIP",
      category: "Streaming",
      price: 16500, // DISESUAIKAN DENGAN products-data.js
      originalPrice: 30000,
    ...
    },
    {
      ...
      name: "HBO Max",
      category: "Streaming",
      price: 19500, // DISESUAIKAN DENGAN products-data.js
      originalPrice: 25000,
    ...
    },
    {
      ...
      name: "Remini Pro",
      category: "Editing",
      price: 13000, // DISESUAIKAN DENGAN products-data.js
      originalPrice: 20000,
    ...
    },
    {
      ...
      name: "Meitu VIP",
      category: "Editing",
      price: 33000, // DISESUAIKAN DENGAN products-data.js
      originalPrice: 55000,
    ...
    },
    {
      ...
      category: "Editing",
      price: 3500, // DISESUAIKAN DENGAN products-data.js
      originalPrice: 15000,
    ...
    // 🔥 AI (PRODUK BARU)
    // Tambahkan produk AI di sini jika diperlukan
...
console.log("✅ Semua harga telah DISINKRONKAN dengan products-data.js");
console.log("✅ Kategori AI ditambahkan");
console.log("✅ Flash sale dan produk populer telah diperbarui:");
console.log("   - Flash Sale: Netflix Premium, Vidio Premium, Youtube Premium, Amazon Prime Video, Bstation Premium, Canva Pro, Alight Motion Pro");
console.log("   - Produk Populer: Netflix Premium, Youtube Premium, Bstation Premium, Spotify Premium, Canva Pro, Alight Motion Pro");
